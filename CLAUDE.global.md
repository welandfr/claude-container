...
- You cannot push to GitHub — there are no SSH keys in the container. Git commits are fine as long as the user asks you to do it; the user handles all pushes manually from the host.
